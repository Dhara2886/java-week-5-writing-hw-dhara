    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (str.equalsIgnoreCase(c)){
                ...
                System.out.println("-----------------------------------------------------------------------");
                //Two for loop for multidimensional array
